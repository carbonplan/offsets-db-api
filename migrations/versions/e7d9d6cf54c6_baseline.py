...
def upgrade() -> None:
    ...
    op.create_index('ix_clip_date', 'clip', ['date'], unique=False)
    op.create_index(op.f('ix_clip_id'), 'clip', ['id'], unique=False)
    op.create_index(
        'ix_clip_source_gin',
        'clip',
        [sa.text('lower(source) gin_trgm_ops')],
        unique=False,
    ...
    op.create_index(
        'ix_clip_type_gin',
        'clip',
        [sa.text('lower(type) gin_trgm_ops')],
        unique=False,
        postgresql_using='gin',
    )
    op.create_table(
    ...
    op.create_index(
        'ix_project_category_gin',
        'project',
        [sa.text('lower(category) gin_trgm_ops')],
        unique=False,
        postgresql_using='gin',
    )
    op.create_index(
        'ix_project_country_gin',
        'project',
        [sa.text('lower(country) gin_trgm_ops')],
        unique=False,
        postgresql_using='gin',
    )
    op.create_index('ix_project_is_compliance', 'project', ['is_compliance'], unique=False)
    op.create_index('ix_project_issued', 'project', ['issued'], unique=False)
    op.create_index('ix_project_listed_at', 'project', ['listed_at'], unique=False)
    op.create_index(
        'ix_project_name_gin',
        'project',
    ...
    op.create_index(
        ...
        'project',
        [sa.text('lower(project_type) gin_trgm_ops')],
        unique=False,
        postgresql_using='gin',
    )
    op.create_index(
    ...
    op.create_index('ix_project_retired', 'project', ['retired'], unique=False)
    op.create_table(
        'clipproject',
        sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index('ix_credit_vintage', 'credit', ['vintage'], unique=False)
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('ix_credit_vintage', table_name='credit')
    ...
    op.drop_index('ix_project_listed_at', table_name='project')
    op.drop_index('ix_project_issued', table_name='project')
    op.drop_index('ix_project_is_compliance', table_name='project')
    op.drop_index('ix_project_country_gin', table_name='project', postgresql_using='gin')
    op.drop_index('ix_project_category_gin', table_name='project', postgresql_using='gin')
    op.drop_table('project')
    op.drop_index(op.f('ix_file_id'), table_name='file')
    op.drop_table('file')
    op.drop_index('ix_clip_type_gin', table_name='clip', postgresql_using='gin')
    op.drop_index('ix_clip_title_gin', table_name='clip', postgresql_using='gin')
    op.drop_index('ix_clip_source_gin', table_name='clip', postgresql_using='gin')
    op.drop_index(op.f('ix_clip_id'), table_name='clip')
    op.drop_index('ix_clip_date', table_name='clip')
    op.drop_table('clip')
    # ### end Alembic commands ###
